...
- Confirm `CHANGELOG.md` describes the `0.2.1` MoonBit 0.10.3 compatibility
  patch after the `0.2.0` workflow-runtime expansion.
...
- Confirm README, `moon.mod`, and Mooncakes latest version are all `0.2.1`.
